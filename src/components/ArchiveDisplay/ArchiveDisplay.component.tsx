 ...
 */
type Month = 'Enero'|'Febrero'|'Marzo'|'Abril'|'Juno'|'Julio'|'Agosto'|'Septiembre'
...
export default class ArchiveDisplayComponent extends Component<ArchiveDisplayComponentProps, {}> {
    render() {
